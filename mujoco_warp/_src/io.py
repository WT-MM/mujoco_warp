...
def put_model(mjm: mujoco.MjModel, batch_sizes: dict[str, int] | None = None) -> types.Model:
  ...
  # bodies that may produce fluid force: routing between the ellipsoid and inertia-box
  # models is per-world (geom_fluid is batched and publicly mutable), so this is a superset
